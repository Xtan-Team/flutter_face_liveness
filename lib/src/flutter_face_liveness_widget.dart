  ...
  Widget _cameraView(LivenessController ctrl) {
    return Stack(
      children: [
        ...
        // Dark/light scrim + animated oval overlay with progress indicator
        Positioned.fill(
            ...
            builder: (_, __) => CustomPaint(
              painter: FaceOverlayPainter(
                ...
                previewSize: ctrl.cameraController != null
                    ...
                    : null,
                isFrontCamera: true,
                progressValue: ctrl.progress,
                progressColor: widget.config.ovalProgressColor,
              ),
            ),
          ),
        ),

        // Main layout with header, oval, and footer
        Positioned.fill(
          child: SafeArea(
            child: Column(
              children: [
              ...
              const  Expanded(
                ...
                // Custom footer or default (instructions)
                if (widget.config.footerBuilder != null)
                  widget.config.footerBuilder!(context)
                else
                  _defaultFooter(ctrl),
              ],
            ),
